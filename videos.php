  ...
  <div class="container py-5">
    <div class="office-program">
      <div class="col-md-6 offset-md-3">
        <h3 class=" text-center py-4 mb-5" style="border-bottom: 1px solid #2D0C2E;">Office Event Videos</h3>
      </div>
      <div class="row">
        <div class="col-md-3">
          <iframe width="100%" height="270" src="https://www.youtube.com/embed/7ydBgdL5R08" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
        <div class="col-md-3">
          <iframe width="100%" height="270" src="https://www.youtube.com/embed/7ydBgdL5R08" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
    ...
    <div class="office-tour">
      <div class="col-md-6 offset-md-3">
        <h3 class=" text-center py-4 my-5" style="border-bottom: 1px solid #2D0C2E;">Office Tour Videos</h3>
      </div>
      <div class="row">
        <div class="col-md-3">
          <iframe width="100%" height="270" src="https://www.youtube.com/embed/7ydBgdL5R08" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
